...
<body>
  ...
  <?php
  $rec = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Faro'");
  ...
  ?>
  <div id="content">
    <?php $results = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Faro'"); ?>
  ...
  <div class="locais">
   ...
   $result = mysqli_query($con, "SELECT * FROM locais WHERE concelho='Faro'");
