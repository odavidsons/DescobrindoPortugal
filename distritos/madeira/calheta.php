...
<body>
  ...
  <?php
  $rec = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Calheta'");
  ...
  ?>
  <div id="content">
    <?php $results = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Calheta'"); ?>
  ...
  <div class="locais">
   ...
   $result = mysqli_query($con, "SELECT * FROM locais WHERE concelho='Calheta'");
