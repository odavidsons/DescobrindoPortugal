...
<body>
  ...
  <?php
  $rec = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Vila Nova de Gaia'");
  ...
  ?>
  <div id="content">
    <?php $results = mysqli_query($db, "SELECT * FROM concelhos WHERE concelho='Vila Nova de Gaia'"); ?>
  ...
  <div class="locais">
   ...
   $result = mysqli_query($con, "SELECT * FROM locais WHERE concelho='Vila Nova de Gaia'");
   while ($row = mysqli_fetch_array($result)) {
     echo "<div style='border:solid 1px #ccc;padding:10px;float:center;margin-top:10px;'>";
       ...
       echo "<tr>";
            ...
            echo "<td>";echo"<img src='" . $row['imagem'] . "'width='500px'>";echo"</td>";
            echo "</tr>";
       echo "</table>";
     echo "</div>";
    }
