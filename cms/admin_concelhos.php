...
<?php
	if (isset($_GET['edit'])) {
		...
		$rec = mysqli_query($db, "SELECT * FROM concelhos WHERE id=$id");
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php endif ?>
		<form method="post" action="db_concelhos.php" >
    ...
    <?php $results = mysqli_query($db, "SELECT * FROM concelhos"); ?>
    <table>
    	<thead>
    		<tr>
					<th>Id</th>
      ...
      <?php while ($row = mysqli_fetch_array($results)) { ?>
        ...
        <td><?php echo $row['imagem']; ?></td>
  			<td>
  				<a href="admin_concelhos.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Editar</a>
  			</td>
  			<td>
  				<a href="db_concelhos.php?del=<?php echo $row['id']; ?>" class="del_btn">Eliminar</a>
  			</td>
  		</tr>
      <?php } ?>
    </table>
